...
export default function Content() {
  return (
    <section className='ml-[4.5rem]'>
        ...
        <section className='flex flex-wrap bg-white  p-[1rem] justify-between w-[90%]'>
            {Categories.slice(5,11).map((product,key)=>{
                return(<div key={product.Id}>
                    <div className='w-[10rem] h-[10rem]'>
                        <img  src={product.image}  className='object-contain w-[100%] h-[100%] border-none' alt={product.title}/>
                    </div>
